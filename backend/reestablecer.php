...
$valor_matricula = $_POST["value_matricula"];

$sql = "SELECT * FROM alumnos WHERE matricula = '$valor_matricula'";
...
if($id != $matricula) {
    ...
    $sql_value = "SELECT * FROM alumnos WHERE matricula = '$valor_matricula'";
...
$sql_value2 = "SELECT * FROM alumnos WHERE matricula = '$valor_matricula'";
